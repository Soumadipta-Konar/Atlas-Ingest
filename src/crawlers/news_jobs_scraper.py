...
class DateNormalizer:
    ...
    def normalize(date_str: Optional[str]) -> datetime:
        ...
        try:
            ...
            # Fix #4: Force UTC if parsedate_to_datetime returns a naive datetime
        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    logger.warning(f"Error processing news item from {source_name}: {e}")
                    continue
        ...
        try:
            ...
            for item in items:
                try:
                    ...
                    logger.warning(f"Error processing job item from {source_name}: {e}")
                    continue
